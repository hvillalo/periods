...
La salida de `lm()` es un objeto de la clase correspondiente que puede aprovechar todas las funciones de R para modelos lineales, por ejemplo extraer el AIC (`AIC(fit)`), obtener las gráficas diagnósticas (`plot(fit)`).
